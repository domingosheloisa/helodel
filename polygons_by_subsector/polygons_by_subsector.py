...
class PolygonsBySubsector:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'PolygonsBySubsector_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Polygons by Subsector')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PolygonsBySubsector', message)
    ...
    def initGui(self):
        ...
        """icon_path = ':/plugins/polygons_by_subsector/icon.png'
        self.add_action(
            icon_path,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = PolygonsBySubsectorDialog()
            self.dlg.pushButton_1.clicked.connect(self.select_dmc_files)
            self.dlg.pushButton_2.clicked.connect(self.select_quad_files)
